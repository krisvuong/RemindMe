...
public class SceneControllerr{
    ...
    public void switchScene1(ActionEvent event) throws IOException {
        ...
        alert.setHeaderText("You haven't filled out all the required info yet!");
        alert.setContentText("Are you sure you want to leave?");

        if(alert.showAndWait().get() == ButtonType.OK){
            root = FXMLLoader.load(getClass().getResource("SceneBuilderr.fxml"));
    ...
    public void switchScene2(ActionEvent event) throws IOException {
        ...
        root = FXMLLoader.load(getClass().getResource("schedulee.fxml"));
        stage = (Stage)((Node)event.getSource()).getScene().getWindow();
        scene = new Scene(root);
        stage.setScene(scene);
        stage.show();
    ...
    public void switchScene3(ActionEvent event) throws IOException {
        root = FXMLLoader.load(getClass().getResource("ganttChartt.fxml"));
        stage = (Stage)((Node)event.getSource()).getScene().getWindow();
        scene = new Scene(root);
        stage.setScene(scene);
        stage.show();
